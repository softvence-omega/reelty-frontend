            ...
            <MaxWidthWrapper>
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="px-4 py-2 border border-red-500/70 hover:border  disabled:opacity-50 rounded-lg transition"
                    >
                    ...
                    <div className="lg:w-3/12 bg-[#1f1f1f] p-6 rounded-xl space-y-6 shadow-lg">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-col gap-2">
                                <label
                                    className={`w-full cursor-pointer py-2 rounded-lg text-center transition ${introFile ? "border border-red-500/70" : "bg-[#27272A] hover:bg-gray-700"
                                        }`}
                                >
                                ...
                                <label
                                    className={`w-full cursor-pointer py-2 rounded-lg text-center transition ${outroFile ? "border border-red-500/70" : "bg-[#27272A] hover:bg-gray-700"
                                        }`}
                                >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex flex-col gap-2">
                                <label
                                    className={`w-full cursor-pointer py-2 rounded-lg text-center transition ${logo ? "border border-red-500/70" : "bg-[#27272A] hover:bg-gray-700"
                                        }`}
                                >
