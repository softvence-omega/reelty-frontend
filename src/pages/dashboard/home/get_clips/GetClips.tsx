    ...
    <div className="min-h-screen py-6 ">
      <MaxWidthWrapper>
        ...
        <div className="text-white flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-medium">World's Fastest Car Vs Cheeta</h2>
        </div>
        ...
        <div className="flex items-center gap-4 mb-10 mt-5">
          {tab.map((item) => (
            <button
              ...
              className={`text-white/50 text-sm font-semibold py-2 px-4 rounded-full transition-all duration-200 ${
